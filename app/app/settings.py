...
DATABASES = {
    'default': {
        ...
        'NAME': 'canillo6_db1',                 # Your database name
        'USER': 'canillo6',                     # Your MySQL username
...
BASE_DIR = Path(__file__).resolve().parent.parent
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_ROOT = '/home/canillo6/development/app/media/'
FORCE_SCRIPT_NAME = '/canillo6'
